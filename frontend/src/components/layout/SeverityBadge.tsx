...
const badgeVariants = cva(
  "flex justify-center w-fit items-center rounded-none border px-2 py-0.5 text-[10px] sm:text-xs font-medium capitalize",
  {
    variants: {
      variant: {
      ...
      theme: {
        critical:
          "bg-red-100 dark:bg-red-950/20 text-red-700 dark:text-red-400 border-red-200 dark:border-red-900",
        CRITICAL:
          "bg-red-100 dark:bg-red-950/20 text-red-700 dark:text-red-400 border-red-200 dark:border-red-900",
        ...
        INFORMATIVE:
          "bg-purple-100 dark:bg-purple-950/20 text-purple-700 dark:text-purple-400 border-purple-200 dark:border-purple-900",
        outlineSecondary:
          "bg-gray-100 dark:bg-gray-950/20 text-gray-700 dark:text-gray-400 border-gray-200 dark:border-gray-800",
        OUTLINE_SECONDARY:
          "bg-gray-100 dark:bg-gray-950/20 text-gray-700 dark:text-gray-400 border-gray-200 dark:border-gray-800",
        success:
          "bg-green-100 dark:bg-green-950/20 text-green-700 dark:text-green-400 border-green-200 dark:border-green-700",
        SUCCESS:
          "bg-green-100 dark:bg-green-950/20 text-green-700 dark:text-green-400 border-green-200 dark:border-green-700",
      },
    },
...
function SeverityBadge({ className, variant, theme, ...props }: SeverityBadgeProps) {
  return (
    <div
...
export { SeverityBadge, badgeVariants };
